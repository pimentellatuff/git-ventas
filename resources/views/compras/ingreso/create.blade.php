			...
			<div class="form-group">
				...
				<select name="idproveedor" id="idproveedor" class="form-control selectpicker" data-Live-search="true">
					@foreach($personas as $persona)
						<option value="{{$persona->idpersonas}}">{{$persona->nombre}}</option>
					@endforeach
				</select>
			</div>
		</div>
			...
			<div class="panel-body">
				<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
						<div class="form-group">
							...
							<select name="piarticulo" class="form-control selectpicker" id="piarticulo" data-Live-search="true">
								@foreach($articulos as $articulo)
									<option value="{{$articulo->idarticulos}}">{{$articulo->articulo}}</option>
								@endforeach
							</select>
						</div>
				</div>
...
<script>
	...
	function agregar(){
		//alert("adija");
		idarticulo=$("#piarticulo").val();
		articulo=$("#piarticulo option:selected").text();
		...
		{
			alert("Error al ingreasar el detalle del ingreso, revise los datos del articulo")
		}
	}
