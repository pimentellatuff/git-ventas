	...
	<div class="row">
		...
		<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
			<div class="form-group">
				...
				<select name="idclientes" id="idclientes" class="form-control selectpicker" data-Live-search="true">
						...
						<div class="form-group">
							...
							<select name="pidarticulo" class="form-control selectpicker" id="pidarticulo" data-Live-search="true">
								@foreach($articulos as $articulo)
									<option value="{{$articulo->idarticulos}}_{{$articulo->stock}}_{{$articulo->precio_promedio}}">{{$articulo->articulo}}</option>
								@endforeach
							</select>
						</div>
				</div>
				...
				<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
					<table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
						...
						<tfoot>
							...
							<th></th>
							<th></th>
							<th><h4 id="total">Bs/. 0.00 </h4><input type="hidden" name="total_ventas" id="total_ventas"></th>
						</tfoot>
						<tbody>
